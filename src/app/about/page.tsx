    ...
    <div className="place-self-center max-w-7xl pt-0 pb-12 pl-16 pr-16 text-left ">
      ...
      <div className="relative flex flex-row justify-between items-center w-full">
        ...
        <div className="w-2/3">
          ...
          where I worked with a team of developers to create
          <Link
      ...
      Discord server across the world. Initially written in Javascript with the
      <URL href="https://discord.js.org/"> discord.js</URL> framework, I rewrote the bot in Typescript.
      ...
      which I attribute my growing desire to work in the field to. I am particularly fond of data science and
      analytics and would love to major in it. One of my biggest dreams is to work data analytics
      for a Major League Baseball team.
      <div className="relative flex flex-row justify-between items-center w-full">
        <div className="w-2/3">
          As for myself, sports have always been a big passion of mine.
          I grew up a St. Louis sports fan and eventually found my way to Seattle-area sports thanks to
          <URL href="https://www.youtube.com/watch?v=TIgK56cAjfY"> an excellent documentary</URL>.
